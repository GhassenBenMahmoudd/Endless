...
@Component({
  selector: 'app-addlogisctic',
  templateUrl: './addlogisctic.component.html',
  styleUrls: ['./addlogisctic.component.css']
})
export class AddlogiscticComponent implements OnInit {
  ...
  constructor(private fb:FormBuilder,private route:Router,private fst:AngularFireStorage,private fs:AngularFirestore) { }
