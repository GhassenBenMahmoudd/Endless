...
const routes: Routes = [
  ...
  {path:'user/:id',component:DetailclubComponent},
  {path:'rental',component:RentalComponent},
  {path:'loginclub',component:LoginclubComponent},
  {path:'interface',component:LogininterfaceComponent},
  {path:'club',component:ClubComponent},
  {path:'addlogistic',component:AddlogiscticComponent},
